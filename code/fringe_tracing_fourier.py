...
def create_filter(fft, R0, theta, radius_of_filter, blur):
    ...
    # two circle filter
    rr, cc = circle_perimeter(r=y1, c=x1, radius=radius_of_filter, shape=fft_filter.shape)
    fft_filter[rr, cc] = 1
    rr, cc = circle_perimeter(r=y2, c=x2, radius=radius_of_filter, shape=fft_filter.shape)
    fft_filter[rr, cc] = 1
